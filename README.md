...
*	Some ebooks, mostly those with large images or a large number of SVG images, become too large when converted to HTML with inline images. These may just be unsuitable for conversion to a single HTML file.
